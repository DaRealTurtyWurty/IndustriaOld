...
public class BlockEntityInit {
    ...
    public static final RegistryObject<BlockEntityType<TreeDecapitatorBlockEntity>> TREE_DECAPITATOR = BLOCK_ENTITIES.register(
            "tree_decapitator",
            () -> BlockEntityType.Builder.of(TreeDecapitatorBlockEntity::new, BlockInit.TREE_DECAPITATOR.get())
                    .build(null));

    public static final RegistryObject<BlockEntityType<EntityInteractorBlockEntity>> ENTITY_INTERACTOR = BLOCK_ENTITIES.register(
            "entity_interactor",
    ...
    public static final RegistryObject<BlockEntityType<ElectricHeaterBlockEntity>> ELECTRIC_HEATER = BLOCK_ENTITIES.register(
            "electric_heater",
            () -> BlockEntityType.Builder.of(ElectricHeaterBlockEntity::new, BlockInit.ELECTRIC_HEATER.get())
                    .build(null));
}
