...
public class ResearcherModel extends Model {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        diagonal0.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0)
                                                              .addBox(-0.5F, -0.65F, -3.6213F, 1.0F, 0.0F, 3.0F,
        ...
        diagonal1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 0)
                                                              .addBox(-0.5F, -0.65F, 0.3787F, 1.0F, 0.0F, 3.0F,
                                                                      new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, -15.25F, 0.0F, 0.0F, -0.7854F, 0.0F));
        ...
        diagonal2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0)
                                                              .addBox(-0.5F, -0.65F, 0.6213F, 1.0F, 0.0F, 3.0F,
                                                                      new CubeDeformation(0.0F)),
        ...
        partDefinition.addOrReplaceChild("frame", CubeListBuilder.create().texOffs(26, 0)
                                                                 .addBox(1.0F, -8.0F, -1.0F, 14.0F, 1.0F, 1.0F,
                                                                         new CubeDeformation(0.0F)).texOffs(24, 24)
                                                                 .addBox(0.0F, -8.0F, -15.0F, 1.0F, 1.0F, 14.0F,
                                                                         new CubeDeformation(0.0F)).texOffs(0, 42)
                                                                 .addBox(0.0F, -8.0F, -1.0F, 1.0F, 13.0F, 1.0F,
                                                                         new CubeDeformation(0.0F)).texOffs(26, 18)
                                                                 .addBox(1.0F, -8.0F, -16.0F, 14.0F, 1.0F, 1.0F,
                                                                         new CubeDeformation(0.0F)).texOffs(4, 42)
                                                                 .addBox(0.0F, -8.0F, -16.0F, 1.0F, 13.0F, 1.0F,
                                                                         new CubeDeformation(0.0F)).texOffs(26, 3)
                                                                 .addBox(15.0F, -8.0F, -15.0F, 1.0F, 1.0F, 14.0F,
                                                                         new CubeDeformation(0.0F)).texOffs(8, 42)
                                                                 .addBox(15.0F, -8.0F, -1.0F, 1.0F, 13.0F, 1.0F,
                                                                         new CubeDeformation(0.0F)).texOffs(12, 42)
                                                                 .addBox(15.0F, -8.0F, -16.0F, 1.0F, 13.0F, 1.0F,
                                                                         new CubeDeformation(0.0F)),
                PartPose.offset(-8.0F, 16.0F, 8.0F));

        partDefinition.addOrReplaceChild("base", CubeListBuilder.create().texOffs(0, 0)
                                                                .addBox(-8.0F, -4.0F, -6.0F, 2.0F, 1.0F, 12.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
                                                                .addBox(6.0F, -4.0F, -6.0F, 2.0F, 1.0F, 12.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
                                                                .addBox(7.0F, -4.0F, -7.0F, 1.0F, 1.0F, 1.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
                                                                .addBox(7.0F, -4.0F, 6.0F, 1.0F, 1.0F, 1.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
                                                                .addBox(-8.0F, -4.0F, -7.0F, 1.0F, 1.0F, 1.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
                                                                .addBox(-8.0F, -4.0F, 6.0F, 1.0F, 1.0F, 1.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
                                                                .addBox(-7.0F, -4.0F, -8.0F, 14.0F, 1.0F, 2.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
                                                                .addBox(-7.0F, -4.0F, 6.0F, 14.0F, 1.0F, 2.0F,
                                                                        new CubeDeformation(0.0F)).texOffs(0, 0)
    ...
    public static class ModelPartHolder {
        private final ModelPart part;
        private final Vector3d position = new Vector3d(0, 0, 0);
        private final Vector3d scale = new Vector3d(0, 0, 0);
        private final Quaternion rotation = Quaternion.ONE;
